...
export type MealLog = { id:string; date:string; meal:string; name:string; qty:string; cal:number; p:number; c:number; f:number; fiber:number; sugar:number; sodium:number; source?:string };
