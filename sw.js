const CACHE_NAME = 'nutrifamily-elder-pro-v2';
const ASSETS = ['/', '/index.html', '/style.css', '/app.js', '/config.js', '/data/foods.js', '/data/exercises.js', '/data/healthRules.js', '/manifest.json'];
